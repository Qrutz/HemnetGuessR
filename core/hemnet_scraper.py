...
selenium_service = Service(
    'C:/Users/Batman/Projects/husjakt/TervsGame/chromedriver.exe')
...
ul_element = driver.find_element(
    By.CLASS_NAME, "normal-results qa-organic-results")
...
for element in listing_elements:
    ...
    image_url = element.find_element(
        By.CLASS_NAME, "js-lazy-load listing-card__image listing-card__image--big").get_attribute("src")
    street_name = element.find_element(
        By.CLASS_NAME, "listing-card__street-address qa-listing-titlek").text
    city = element.find_element(
        By.CLASS_NAME, "listing-card__location-name").text
