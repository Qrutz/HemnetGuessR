...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen items-center justify-center bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] bg-gradient-to-b from-emerald-950 from-sky-400 to-emerald-900  to-sky-200 font-mono">
        <div className="container mx-auto w-[28rem] rounded-lg bg-white">
          <div className="flex flex-col justify-center p-4">
            ...
            <div className="space-y-1">
              ...
              <Link href="/game">
                <button className="w-full bg-slate-600 bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-sky-400 to-cyan-300  p-3 text-xl font-extrabold text-white">
                  {someState}
                </button>
              </Link>
            </div>
